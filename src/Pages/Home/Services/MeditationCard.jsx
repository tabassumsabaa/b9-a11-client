...
const MeditationCard = ({yoga}) => {
    ...
    const {provide_image, provide_name, provide_description, price } = yoga;

    return (
        <div className="card bg-base-100 w-96 shadow-xl mb-10">
        <figure className="px-10 pt-10">
          <img src={provide_image} alt="Shoes" className="rounded-xl" />
        </figure>
        <div className="card-body items-center text-center">
          <h2 className="card-title">{provide_name}</h2>
